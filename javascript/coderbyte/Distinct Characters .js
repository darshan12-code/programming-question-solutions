...
function DistinctCharacters(str) {
    return Array.from(new Set(str.split(''))).length >= 10;
}

// Test cases
console.log(DistinctCharacters("12334bbmma:=6")); // Output: true
console.log(DistinctCharacters("eeeeemmmmmmmmm1000")); // Output: false
